                    ...
                    <div class="body">
                        <form id="add-manufacturor" method="post" action="{{ route('manufacturers.store') }}" novalidate
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="fancy-checkbox">
                                        <label><input type="checkbox" name="top_brands" value="1"><span>Top Brand</span></label>
                                    </div>
                                </div>

                                <div class="col-lg-3">
                                    <div class="fancy-checkbox">
                                        <label><input type="checkbox" name="home_top_brands" value="1"><span>Top Brand (Homepage)</span></label>
                                    </div>
                                </div>
