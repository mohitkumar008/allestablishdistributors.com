...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="invest_box_new">
                                ...
                                <ul>
                                    <li>
                                        <a class="invest_box" href="javascript:void(0)">
                                            <h4>Investments</h4>
                                            <p>Under 5 Lacs</p>
                                        </a>
                                    </li>
                ...
                <div class="col-lg-4 col-sm-12 col-12">
                    <div class="row">
                        <div class="col-lg-6 col-sm-3 col-6 p-0">
    ...
    <section class="cat_home_sec">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 col-sm-12 cat_circle_box">
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="heading_title">
                                <h5>Top categories</h5>
                                <a class="btn btn-show-more" href="javascript:void(0)"> Show more</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-4 col-12 p-0">
                        <div class="card">
                            ...
                            <div class="card-body px-0 pb-0">
                                ...
                                <h5 class="knw_mt">
                                    <a class="btn btn-theme btn-bdr w-100" href="{{route('manufacturerDetails', ['slug' => $topManufacturer->company_slug])}}">
                                        Know more</a>
                                </h5>
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#SendEnquiresModel"
                                    data-product-id="0" data-manufacturer-id="{{$topManufacturer->id}}" onclick="SetDistributorshipAttr(this)"
                                    class="btn btn-theme w-100">Apply For
                                    Distributorship</a>
                            </div>
                        </div>
                    </div>
                ...
                @foreach ($featuredManufacturers as $featuredManufacturer)
                    <div class="col-lg-2 col-sm-4 col-12 p-0">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body px-0 pb-0">
                                <a href="javascript:void(0)" class="btn btn-distbt">{{$featuredManufacturer->category->title}}</a>
                                ...
                                <h5 class="knw_mt">
                                    <a class="btn btn-theme btn-bdr w-100" href="{{route('manufacturerDetails', ['slug' => $featuredManufacturer->company_slug])}}">
                                        Know more</a>
                                </h5>
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#SendEnquiresModel"
                                    data-product-id="0" data-manufacturer-id="{{$featuredManufacturer->id}}" onclick="SetDistributorshipAttr(this)"
                                    class="btn btn-theme w-100">Send Enquiry</a>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="row">
                ...
                <div class="col-md-6 pd-l-10">
                    <div class="post_requirement m-0">
                        ...
                        <form class="row" action="{{route('sendRequirement')}}"
